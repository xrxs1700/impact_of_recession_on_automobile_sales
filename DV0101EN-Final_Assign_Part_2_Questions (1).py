...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure = px.pie(exp_rec,
                ...
                names = 'Vehicle_Type',
                title = 'Expenditure Share of Each Vehicle Type over Recession Period'
            )
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure = px.bar(unemployment_data,
                x = 'Vehicle_Type',
                y = 'unemployment_rate',
                title = 'Effect of Unemployment Rate on Vehicle Type over Recession Period'
            )
        )
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            figure = px.pie(exp_data,
                values = 'Advertising_Expenditure',
                names = 'Vehicle_Type',
                title = 'Advetising Expenditure by Vehicle Type in {}'.format(input_year)
            )
        )

#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                html.Div(className='chart-item', children=[html.Div(Y_chart1),html.Div(Y_chart3)]),
                html.Div(className='chart-item', children=[html.Div(Y_chart2),html.Div(Y_chart4)])
                ]
